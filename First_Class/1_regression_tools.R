...
bikeTrain <- GetBikeData("D:/CEU/Data_Science_1/machine-learning-course/data/bike_rental/bike_rental_train.csv")
bikeTrain$weather

bikeTest <- GetBikeData("D:/CEU/Data_Science_1/machine-learning-course/data/bike_rental/bike_rental_test.csv")
bikeTest
...
lmElasticNetCaret <- train(logcount~quarter+temp+atemp+weather+windspeed, 
                 data = bikeTrain, 
                 method = "glmnet",
                 trControl=trctrl,
                 tuneLength=10
